...
import edu.concordia.comp354.model.PERTEvent;
...
public class PERTBoxShape extends mxRectangleShape {
    ...
    public static final int PERT_BOX_LENGTH = 100;
    DecimalFormat df = new DecimalFormat("##.##");
//    static {
//        mxGraphics2DCanvas.putShape(SHAPE_PERTBOX, new PERTBoxShape());
//    }
    ...
    public void paintShape(mxGraphics2DCanvas canvas, mxCellState state) {
        ...
        if (configureGraphics(canvas, state, false)) {
            ...
            PERTEvent event = (PERTEvent) ((mxCell) state.getCell()).getValue();
