...
public class CreateAct {
	...
	private void initialize() {
		...
		lblProject.setText("New activity for project " + MainDialogWindow.selectedProject.getProject_name());
		...
		ActivityController ac = new ActivityController();
		List<Activity> l = ac.getActByProjectId(MainDialogWindow.selectedProject.getProject_id());
