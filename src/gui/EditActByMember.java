...
public class EditActByMember extends JDialog {
	...
	public EditActByMember() {
		...
		newProgress.setText(MainWindow.selectedAct.getProgress() + "");
		
		final JTextArea newDes = new JTextArea();
		newDes.setBounds(20, 116, 202, 104);
		contentPanel.add(newDes);
		newDes.setText(MainWindow.selectedAct.getActivity_desc());
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent e){
						...
						ac.updateActivity(MainWindow.selectedAct.getActivity_id(), progress, des);
