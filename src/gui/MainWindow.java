...
//		frmProjectManagementSystem.setResizable(false);
		...
		mntmNewProject.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				if(currentUser.getRole().equals("Project Manager")){
					...
					JOptionPane.showMessageDialog(null, "Sorry, you don't have the access to create new projects!");
				}
			}
		});
		...
		mntmDeleteProject.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				if(currentUser.getRole().equals("Project Manager")){
					...
					JOptionPane.showMessageDialog(null, "Sorry, you don't have the access to delete projects!");
				}
			}
		});
		...
		panel.setBounds(0, 0, 535, 200);
		panel.setLayout(null);
		panel.setMaximumSize(new Dimension(200,535));
		panel.setMinimumSize(new Dimension(200,535));
...
//                    	updateActivityList();
		...
		frmProjectManagementSystem.getContentPane().add(activityEntry.panel1, gbc);
	}
}
